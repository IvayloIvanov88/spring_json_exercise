...
public class GlobalConstant {
    ...
    public static final String EX_1_OUTPUT_PATH = "src/main/resources/files/outputEx1.txt";
    public static final String EX_2_OUTPUT_PATH = "src/main/resources/files/outputEx2.txt";
}
